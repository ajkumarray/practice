...
Binary search is a fast search algorithm with run-time complexity of O(log n).
 ...
 For this algo to work properly,the data collection should be in the sorted form.
...
Binary search looks for a particular item by comparing the middle most item of the collection.
 ...
 This process continues on the sub-array as well untill the size of the sub-array reduces to zero.
 */
